...
import com.ralvez.myapplicationlayout07.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myData2 = MyDataTest2.myDataList
        //var myAdapter = MyAdapter(myData2)
        var myAdapter = SubjectAdapter(myData1)
